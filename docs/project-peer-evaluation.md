...
- **Milestone 1: Practice Peer Evaluation**
- **Milestone 2: Design Requirements Report**
- **Milestone 4: Final Report and Prototype**

Milestone 1 will be used as a practice peer evaluation to make sure the peer evaluation tools are working as expected and that everyone understands the process before peer evaluations are applied for marks. Milestones 2 and 4 will be used for marks and will apply a peer evaluation multiplier to each student’s milestone grade.
...
Peer evaluation will be used for **Milestone 1** as a practice round. The purpose of this practice round is to make sure the peer evaluation tools are working as expected and that everyone understands the process before peer evaluations are applied for marks in later milestones.
...
## Graded Peer Evaluations for Milestones 2 and 4

Peer evaluation will be applied for marks to the following two project milestones:

- **Milestone 2: Design Requirements Report**
- **Milestone 4: Final Report and Prototype**

For each of these milestones, the group will receive a milestone grade. Each student’s individual grade for that milestone will then be adjusted using a peer evaluation multiplier.
...
|                  Item                  |  Score   |
| :------------------------------------: | :------: |
| Average peer evaluation score received | 26.25/30 |
|              Late penalty              |    -1    |
|     Adjusted peer evaluation score     | 25.25/30 |
...
- writing vague comments such as “good job” or “did not help” without specific examples;
...
Detailed rubrics with descriptions can be found here: [Peer Evaluation Rubrics](https://tiny.cc/group-peer-eval-criteria).